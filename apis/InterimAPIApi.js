...
export const popularEventsGET = async (Constants, _args, handlers, timeout) => {
...
export const usePopularEventsGET = (
  args = {},
  {
    refetchInterval,
  ...
  return useQuery(
    ['Events', args],
    () => popularEventsGET(Constants, args, handlers, timeout),
    {
      refetchInterval,
      refetchOnWindowFocus,
      refetchOnMount,
...
export const FetchPopularEventsGET = ({
  children,
  onData = () => {},
  handlers = {},
  refetchInterval,
  ...
  return children({ loading, data, error, refetchPopularEvents: refetch });
};
