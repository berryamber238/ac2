...
const BottomTabNavigation2Block = props => {
  const { theme } = props;
  const dimensions = useWindowDimensions();

  return (
    <View
      {...GlobalStyles.ViewStyles(theme)['Bottom Tab Navigation'].props}
      style={StyleSheet.applyWidth(
        GlobalStyles.ViewStyles(theme)['Bottom Tab Navigation'].style,
        dimensions.width
      )}
    >
      {/* Tab Buttons View */}
            ...
            >
              ...
              >
                ...
                <Image
                  ...
                  source={imageSource(Images['Home'])}
                  style={StyleSheet.applyWidth(
                    StyleSheet.compose(
            ...
            >
              ...
              >
                ...
                <Image
                  resizeMode={'cover'}
                  {...GlobalStyles.ImageStyles(theme)['Image'].props}
                  source={imageSource(Images['TicketFill'])}
                  style={StyleSheet.applyWidth(
                    StyleSheet.compose(
                      GlobalStyles.ImageStyles(theme)['Image'].style,
                      { height: 20, width: 20 }
...
export default withTheme(BottomTabNavigation2Block);
