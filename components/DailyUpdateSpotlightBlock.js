                    ...
                    onScroll={event => {
                      const handler = async () => {
                        try {
                          ...
                          setIsLoading(true);
                          const result = (
                            await AceCampTestApi.dailyupdateSpotlightGET(
                              Constants,
                              {
                                collection:
                          ...
                          if (result?.data?.length > 0) {
                            setPage(page + 1);
                            setFeedsData(feedsData.concat(result?.data));
                            await waitUtil({ milliseconds: 1000 });
                          } else {
                          }
...
export default withTheme(DailyUpdateSpotlightBlock);
