          ...
          try {
            navigation.push('WebViewScreen', {
              url:
                Constants['base_url'] +
                '/playback/' +
                (props.item ?? defaultProps.item)?.goods_info?.id,
            });
          } catch (err) {
            console.error(err);
          }
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {
                  (props.item ?? defaultProps.item)?.goods_info?.meeting?.event
                    ?.name
                }
              </Text>
            </View>
...
export default withTheme(MyBuyLiveBlock);
