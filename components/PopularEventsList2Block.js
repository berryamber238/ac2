...
const PopularEventsList2Block = props => {
  const { theme } = props;
    ...
    >
      ...
      >
        ...
        <Touchable
          ...
          style={StyleSheet.applyWidth(
            { marginBottom: 14, marginRight: 10, width: 160 },
            dimensions.width
          )}
        >
          {/* Popular Card Shadow */}
                  ...
                  >
                    ...
                    >
                      ...
                      <Text
                        accessible={true}
                        selectable={false}
                        {...GlobalStyles.TextStyles(theme)['Body S Medium']
                          .props}
                        ellipsizeMode={'tail'}
                        numberOfLines={1}
                        style={StyleSheet.applyWidth(
...
export default withTheme(PopularEventsList2Block);
