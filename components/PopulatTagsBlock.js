...
const PopulatTagsBlock = props => {
  ...
  return (
    <View
      {...GlobalStyles.ViewStyles(theme)['Popular Tags 3'].props}
      style={StyleSheet.applyWidth(
        GlobalStyles.ViewStyles(theme)['Popular Tags 3'].style,
        dimensions.width
      )}
    >
      {/* Tags Scroll */}
      ...
      >
        ...
        <View
          ...
          style={StyleSheet.applyWidth(
            StyleSheet.compose(GlobalStyles.ViewStyles(theme)['Tag'].style, {
              marginRight: 12,
            }),
            dimensions.width
          )}
...
export default withTheme(PopulatTagsBlock);
