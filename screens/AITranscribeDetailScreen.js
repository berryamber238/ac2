...
const defaultProps = { id: 1183637849 };

const AITranscribeDetailScreen = props => {
  ...
  return (
    <ScreenContainer hasSafeArea={false} scrollable={false}>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {t(Variables, 'article_detail_orginal_minutes')}
              </Text>
            </View>
          </Touchable>
        </View>
        ...
        <View style={StyleSheet.applyWidth({ padding: 16 }, dimensions.width)}>
            ...
            {!(current_tab === 3) ? null : (
              ...
              >
                <SimpleStyleFlatList
                  ...
                  keyboardShouldPersistTaps={'never'}
                  listKey={'Scroll View->View 2->View->List'}
                  nestedScrollEnabled={false}
                    ...
                    return (
                      ...
                      >
                        <View
                          style={StyleSheet.applyWidth(
                            {
                              backgroundColor: 'rgb(227, 237, 250)',
                              borderRadius: 4,
                              marginRight: 6,
                              marginTop: 6,
                              paddingBottom: 4,
          ...
          <>
            {!(current_tab === 1) ? null : (
              ...
              >
                <Utils.CustomCodeErrorBoundary>
                  <gf.RenderHtml source={{ html: `${t_data.qa}` }} />
                </Utils.CustomCodeErrorBoundary>
              </View>
            )}
          </>
          ...
          <>
            {!(current_tab === 2) ? null : (
              ...
              >
                <Utils.CustomCodeErrorBoundary>
                  <gf.RenderHtml source={{ html: `${t_data.keypoints}` }} />
                </Utils.CustomCodeErrorBoundary>
              </View>
            )}
          </>
            ...
            {!(current_tab === 4) ? null : (
              <View>
                <Table
                  ...
                  listKey={'Scroll View->View 2->View 4->Table'}
                  renderItem={({ item, index }) => {
                    ...
                    return (
                      <>
                        <TableRow
                          ...
                          borderColor={palettes.App['Custom Color 13']}
                          drawBottomBorder={false}
                          drawEndBorder={true}
                          drawTopBorder={true}
                          isTableHeader={true}
                        >
                          ...
                          >
                            <Text
                              accessible={true}
                              selectable={false}
                              {...GlobalStyles.TextStyles(theme)['13 Regular']
                                .props}
                              style={StyleSheet.applyWidth(
                                StyleSheet.compose(
                                  GlobalStyles.TextStyles(theme)['13 Regular']
                            ...
                            >
                              {t(Variables, 'ai_keynumber_cell_1')}
                            </Text>
                          </TableCell>
                          {/* Table Cell 4 */}
                          <TableCell
                          ...
                          >
                            ...
                            >
                              {t(Variables, 'ai_keynumber_cell_2')}
                            </Text>
                          </TableCell>
                          {/* Table Cell 3 */}
                          <TableCell
                          ...
                          >
                            ...
                            >
                              {t(Variables, 'ai_keynumber_cell_3')}
                            </Text>
                          </TableCell>
                          {/* Table Cell 2 */}
                          <TableCell
                          ...
                          >
                            ...
                            >
                              {t(Variables, 'ai_keynumber_cell_4')}
                            </Text>
                          </TableCell>
                        </TableRow>
                        {/* Table Row 2 */}
                ...
                />
                {/* Fetch 2 */}
                <AceCampTestApi.FetchGetTranscribesKeynumbersGET
                  handlers={{
                    onData: fetch2Data => {
                      try {
                        console.log(fetch2Data);
                        setNumber_data(fetch2Data?.data?.results);
                      } catch (err) {
                        console.error(err);
                      }
                    },
                ...
                >
                  {({
                    ...
                    error,
                    data,
                    refetchGetTranscribesKeynumbers,
                  }) => {
      ...
      <AceCampTestApi.FetchGetTranscribesGET
        handlers={{
          onData: fetchData => {
            try {
        ...
        id={props.route?.params?.id ?? defaultProps.id}
      >
        {({ loading, error, data, refetchGetTranscribes }) => {
...
export default withTheme(AITranscribeDetailScreen);
