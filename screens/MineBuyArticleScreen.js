...
import MyBuyArticleBlock from '../components/MyBuyArticleBlock';
...
const MineBuyArticleScreen = props => {
            ...
            <>
              <SimpleStyleFlatList
                ...
                renderItem={({ item, index }) => {
                  const listData = item;
                  return <MyBuyArticleBlock item={listData} />;
                }}
...
export default withTheme(MineBuyArticleScreen);
