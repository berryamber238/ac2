...
import MyBuyLiveBlock from '../components/MyBuyLiveBlock';
      ...
      <View>
        ...
        >
          ...
          >
            ...
            >
              {t(Variables, 'mine_buy_live')}
            </Text>
          </View>
        </View>
      </View>

      <AceCampTestApi.FetchOrdersHistoryGET
        goods_type={'Agora::Live'}
        handlers={{
          on401: fetchData => {
            try {
        ...
        retry={1}
      >
        {({ loading, error, data, refetchOrdersHistory }) => {
            ...
            <>
              <SimpleStyleFlatList
                ...
                onEndReached={() => {
                  const handler = async () => {
                    try {
                      ...
                      setIs_loading(true);
                      const result = (
                        await AceCampTestApi.ordersHistoryGET(Constants, {
                          goods_type: 'Agora::Live',
                ...
                renderItem={({ item, index }) => {
                  const listData = item;
                  return <MyBuyLiveBlock item={listData} />;
                }}
...
export default withTheme(MineBuyLiveScreen);
